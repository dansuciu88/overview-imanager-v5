                    ...
                    <div class="col-md-12 grid-margin">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="post" action="{{ route('store.documents') }}" class="forms-sample">
                                    @csrf
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="document_projectId" class="form-control @error('document_projectId') is-invalid @enderror">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="date" name="document_start" class="form-control @error('document_start') is-invalid @enderror">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="date" name="document_end" class="form-control @error('document_end') is-invalid @enderror">
                                                @error('document_end')
                                                <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>

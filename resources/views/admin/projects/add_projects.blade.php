                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="project_client" class="form-control @error('project_client') is-invalid @enderror">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="project_address" class="form-control @error('project_address') is-invalid @enderror">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="project_description" class="form-control @error('project_description') is-invalid @enderror">
